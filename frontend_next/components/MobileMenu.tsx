        ...
        <div className="flex-1 overflow-y-auto py-4">
          <nav className="flex flex-col gap-2 px-4">
            ...
            <div className="space-y-1">
              ...
              >
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider group-hover:text-[#1A1A1A] transition-colors">
                  {t("categories")}
                </span>
                <ChevronDown
                  className={`w-4 h-4 text-gray-400 transition-transform duration-200 ${
                    isCategoriesOpen ? "rotate-180 text-[#C8102E]" : ""
                  }`}
                />
              </button>
