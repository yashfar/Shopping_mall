      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-2xl border border-[#A9A9A9] shadow-sm overflow-hidden">
          ...
          <div className="p-8 space-y-6">
            <div className="space-y-1">
              <label className="text-xs font-black text-[#A9A9A9] uppercase tracking-wider">
                {t("emailAddress")}
              </label>
            ...
            <div className="flex gap-12">
              <div className="space-y-1">
                ...
                <p className="text-lg font-bold text-[#C8102E] capitalize">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-mono font-medium text-[#1A1A1A] opacity-60">
        ...
        <div className="flex flex-col gap-4">
          <div className="bg-red-50 border border-[#C8102E]/10 p-8 rounded-2xl flex-1 flex flex-col justify-center">
            <h3 className="text-xl font-black text-[#C8102E] mb-2">
              {t("welcomeBack")}
            </h3>
          ...
          >
            ...
            <svg
              ...
              strokeWidth={2.5}
              stroke="currentColor"
              className="w-5 h-5 text-[#C8102E] group-hover:translate-x-1 transition-transform"
            >
              <path
                strokeLinecap="round"
