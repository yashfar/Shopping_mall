    ...
    <>
      ...
      <div className="bg-[#FAFAFA] min-h-screen pb-20 md:pb-12">
        <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
                ...
                <div className="relative aspect-[4/5] md:aspect-square w-full bg-white rounded-3xl overflow-hidden border border-[#A9A9A9]/20 shadow-sm group">
                  {displayImages.length > 0 ? (
                    <>
                      ...
                      />
                      {/* Zoom hint */}
                      <div className="absolute bottom-3 right-3 p-2 rounded-full bg-black/30 text-white opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <a
                    href="#reviews"
                    className="text-sm font-medium text-[#A9A9A9] hover:text-[#C8102E] underline underline-offset-4 transition-colors"
                  >
              ...
              <div className="mb-8 p-6 bg-white border border-[#A9A9A9]/20 rounded-2xl shadow-sm">
                <div className="flex flex-col gap-2">
                  <span className="text-sm font-medium text-[#A9A9A9] uppercase tracking-wide">
                    {t("totalPrice")}
                  </span>
              ...
              {hasAnyStock ? (
                <div className="space-y-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    >
                      <Heart
                        className={`w-6 h-6 ${wishlisted ? "fill-[#C8102E]" : ""}`}
                      />
                    </button>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  >
                    <Heart
                      className={`w-5 h-5 ${wishlisted ? "fill-[#C8102E]" : ""}`}
                    />
                  ...
                  >
                    <Bell
                      className={`w-5 h-5 ${stockAlertSubscribed ? "fill-amber-400" : ""}`}
                    />
                    {stockAlertLoading
                      ? "..."
                      : stockAlertSubscribed
          ...
          <div
            id="reviews"
            className="max-w-7xl mx-auto md:pt-20 border-t border-gray-100 mt-20"
          >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
              ...
              <div className="lg:col-span-4 space-y-10">
                {/* Summary Header */}
                <div>
                  <h2 className="text-3xl font-black text-[#1A1A1A] mb-2 tracking-tight">
                    {t("customerReviews")}
                  </h2>
                    ...
                    <div className="space-y-3 mb-10">
                      {[5, 4, 3, 2, 1].map((star) => {
                        ...
                        return (
                          ...
                          >
                            <div className="font-bold text-[#1A1A1A] w-3">
                              {star}
                            </div>
                            ...
                            <div className="w-8 text-right text-gray-400 font-medium">
                ...
                <div className="space-y-6">
                  {product.reviews.length > 0 ? (
                    product.reviews.map((review) => (
                      <div
                        key={review.id}
                        className="group bg-white rounded-3xl p-8 border border-gray-100 hover:border-gray-200 hover:shadow-[0_8px_30px_rgba(0,0,0,0.04)] transition-all duration-300"
                      >
                        ...
                        {review.comment ? (
                          <div className="relative">
                            <svg
                              className="absolute -top-3 -left-2 w-8 h-8 text-gray-100 -z-10 transform -scale-x-100"
                              fill="currentColor"
                              viewBox="0 0 32 32"
                            >
      ...
      {lightboxOpen && displayImages.length > 0 && (
        ...
        >
          ...
          {/* Main Image */}
          <div
            className="relative w-full h-full max-w-5xl max-h-[90vh] mx-4 md:mx-16"
          ...
          {displayImages.length > 1 && (
            <>
              <button
                className="absolute left-2 md:left-6 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-white/10 hover:bg-white/25 text-white transition-all"
                onClick={(e) => {
                  e.stopPropagation();
                  lightboxPrev();
                }}
              ...
              <button
                className="absolute right-2 md:right-6 top-1/2 -translate-y-1/2 z-10 p-3 rounded-full bg-white/10 hover:bg-white/25 text-white transition-all"
                onClick={(e) => {
                  e.stopPropagation();
                  lightboxNext();
                }}
          ...
          {displayImages.length > 1 && (
            <div
              className="absolute bottom-4 left-1/2 -translate-x-1/2 flex gap-2 px-4 py-2 bg-black/40 rounded-2xl"
              onClick={(e) => e.stopPropagation()}
            >
              {displayImages.map((img, idx) => (
                <button
                  ...
                  className={`relative w-12 h-12 rounded-lg overflow-hidden border-2 transition-all flex-shrink-0 ${lightboxIndex === idx ? "border-white scale-110" : "border-white/30 opacity-60 hover:opacity-100"}`}
                >
