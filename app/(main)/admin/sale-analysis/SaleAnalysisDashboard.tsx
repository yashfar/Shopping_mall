...
type Labels = {
    ...
    estProfit: string;
    basedOnMargin: string;
    estTax: string;
    includedInRevenue: string;
    lowStockItems: string;
    lowStockDesc: string;
    monthlySalesTitle: string;
    monthlySalesDesc: string;
        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.todayOrders}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.fromYesterday}</p>
                </div>

                {/* Card 2: Pending Shipments */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.pendingShipments}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.ordersReady}</p>
                </div>

                {/* Card 3: Today's Revenue */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.todayRevenue}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.dailyEarnings}</p>
                </div>

                {/* Card 4: Monthly Revenue */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.monthlyRevenue}</h3>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 text-gray-500"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
                    </div>
                    <div className="text-2xl font-bold text-[#1A1A1A]">{formatCurrency(monthlyRevenue)}</div>
                    <p className="text-xs text-gray-400 mt-1">{l.currentMonthTotal}</p>
                </div>

                {/* Card 5: Est. Profit */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.estProfit}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.basedOnMargin}</p>
                </div>

                {/* Card 6: Estimated Tax */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.estTax}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.includedInRevenue}</p>
                </div>

                {/* Card 7: Low Stock */}
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex flex-row items-center justify-between space-y-0 pb-2">
                        <h3 className="tracking-tight text-sm font-medium text-gray-500">{l.lowStockItems}</h3>
                    ...
                    <p className="text-xs text-gray-400 mt-1">{l.lowStockDesc}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    <div className="mb-4">
                        <h3 className="text-lg font-bold text-[#1A1A1A]">{l.monthlySalesTitle}</h3>
                        <p className="text-sm text-gray-500">{l.monthlySalesDesc}</p>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
                    <div className="mb-4">
                        <h3 className="text-lg font-bold text-[#1A1A1A]">{l.visitorsTitle}</h3>
                        <p className="text-sm text-gray-500">{l.visitorsDesc}</p>
                    </div>
                    <div className="h-[300px] w-full">
                        <ResponsiveContainer width="100%" height="100%">
