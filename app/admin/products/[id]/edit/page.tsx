...
import "../../new/new-product.css"; // Reuse existing styles
    ...
    if (loading) {
        return (
            <div className="new-product-container">
                <div style={{ textAlign: "center", padding: "40px" }}>Loading product details...</div>
            </div>
        );
    }
            ...
            <form onSubmit={handleSubmit} className="product-form">
                ...
                <div className="form-section">
                    ...
                    <p className="section-description">
                        Manage product images. Upload new ones or delete existing ones. first image is thumbnail.
                    </p>
                    ...
                    <div className="upload-area">
                        ...
                        <label htmlFor="image-upload" className="upload-label">
                            ...
                            <span className="upload-text">
                                {uploading ? "Uploading images..." : "Click to upload new images"}
                            </span>
